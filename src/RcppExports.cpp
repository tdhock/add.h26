...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type input1(input1SEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type input2(input2SEXP);
    rcpp_result_gen = Rcpp::wrap(add_interface(input1, input2));
